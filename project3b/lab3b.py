...
#https://stackoverflow.com/questions/2099121/why-do-inode-numbers-start-from-1-and-not-0 inode start from 1 not 0
        ...
        for dir in dirinfos:
                if dir.dir_name == "'.'":
                        if dir.parent_inode != dir.dir_inode:
                                exit_status=2
                                print("DIRECTORY INODE {} NAME '.' LINK TO INODE {} SHOULD BE {}".format(dir.parent_inode, dir.dir_inode, dir.parent_inode))
                if dir.dir_name == "'..'":
                    if dir.dir_inode == 2:
                        belongmap[dir.dir_inode]=2
                    #https://unix.stackexchange.com/questions/198673/why-does-have-the-inode-2
                    if dir.dir_inode != belongmap[dir.parent_inode]:
                        exit_status=2
                        print("DIRECTORY INODE {} NAME '..' LINK TO INODE {} SHOULD BE {}".format(dir.parent_inode, dir.dir_inode, dir.parent_inode))
